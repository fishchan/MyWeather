...
/**
 * 调用方法：String apiUrl=GoodWeatherUrlUtil.getInterfaceURL(城市编号,数据类型);
 */
...
public class WeatherUrlUtil {
	...
	private static final String appid = "83f33b8f04cb8926";
	private static final String private_key = "88e3e4_SmartWeatherAPI_6910f44";
